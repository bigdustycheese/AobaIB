...
{
	$("#switch").attr("href", Cookies.get("mitsuba_style"));
}
...
function addStylechanger()
{
	...
	$("#stylechanger").change(function (e) {
		...
		Cookies.get("mitsuba_style", absolutizeURI(window.location.href, e.target.options[e.target.selectedIndex].value), {expires: 31, path: '/'});
	});
}
