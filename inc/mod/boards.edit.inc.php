...
<?php if (($data['type'] == "imageboard") || ($data['type'] == "textboard") || ($data['type'] == "fileboard") || ($data['type'] == "linkboard")) { ?>
    ...
    <?php echo $lang['mod/board_short']; ?>: <input type="text" name="des" value="<?php echo $data['des']; ?>" /><br />
...
} ?> /><?php echo $lang['mod/board_no_name']; ?><br />
    <input type="checkbox" name="ids" value="1" <?php if ($data['ids'] == 1) { echo "checked "; 
} ?> /><?php echo $lang['mod/board_ids']; ?><br />
    <input type="checkbox" name="bbcode" value="1" <?php if ($data['bbcode'] == 1) { echo "checked "; 
} ?> /><?php echo $lang['mod/board_bbcode']; ?><br />
    <input type="checkbox" name="hidden" value="1" <?php if ($data['hidden'] == 1) { echo "checked "; 
} ?> /><?php echo $lang['mod/board_hidden']; ?><br />
    <input type="checkbox" name="unlisted" value="1" <?php if ($data['unlisted'] == 1) { echo "checked "; 
} ?> /><?php echo $lang['mod/board_unlisted']; ?><br />
    <input type="checkbox" name="captcha" value="1" <?php if ($data['captcha'] == 1) { echo "checked "; 
} ?> /><?php echo $lang['mod/board_captcha']; ?> <br />
<?php } ?>

<?php if (($data['type'] == "imageboard") || ($data['type'] == "fileboard") || ($data['type'] == "linkboard")) { ?>
    <input type="checkbox" name="spoilers" value="1" <?php if ($data['spoilers'] == 1) { echo "checked "; 
} ?> /><?php echo $lang['mod/board_spoilers']; ?><br />
    <input type="checkbox" name="nodup" value="1" <?php if ($data['nodup'] == 1) { echo "checked "; 
} ?> /><?php echo $lang['mod/board_nodup']; ?>
<?php } ?><br />

<?php if ($data['type'] == "imageboard") { ?>
    <input type="checkbox" name="embeds" value="1" <?php if ($data['embeds'] == 1) { echo "checked "; 
} ?> /><?php echo $lang['mod/board_embeds']; ?><br />
    <input type="checkbox" name="nofile" value="1" <?php if ($data['nofile'] == 1) { echo "checked "; 
} ?> /><?php echo $lang['mod/board_nofile']; ?><br />
    <input type="checkbox" name="catalog" value="1" <?php if ($data['catalog'] == 1) { echo "checked "; 
} ?> /><?php echo $lang['mod/board_catalog']; ?><br />
<?php } ?>

<?php if (($data['type'] == "fileboard") || ($data['type'] == "linkboard")) { ?>
    <input type="checkbox" name="replies" value="1" <?php if ($data['allow_replies'] == 1) { echo "checked "; 
} ?> /><?php echo $lang['mod/board_allow_replies']; ?><br />
<?php } ?>

<?php if ($data['type'] == "fileboard") { ?>
    <input type="checkbox" name="file_replies" value="1" <?php if ($data['file_replies'] == 1) { echo "checked "; 
} ?> /><?php echo $lang['mod/board_allow_file_replies']; ?><br />
<?php } ?>
