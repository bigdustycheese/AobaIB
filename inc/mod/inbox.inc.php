    ...
    <?php  //}else{?>
      ...
      <div class="box box-primary">
        ...
        <div class="box-header with-border">
          ...
          <h3 class="box-title">Inbox <?php echo "<small>".$pms." unread</small>" ?></h3>
        ...
        <div class="box-body no-padding">
          ...
          <div class="table-responsive mailbox-messages">
                <?php
                $unreadNumbers = $conn->query("SELECT * from `pm`")->num_rows;
                ?>
                <?php if (($pms <= 0) && ($unreadNumbers == 0)) {

                    echo '<br /><div class="box box-solid box-success">

								<div class="box-header">

							  	<h3 class="box-title"><i class="fa fa-thumbs-up"></i> Nice!</h3>
