<?php
//READ: IF YOU ARENT RUNNING PHP 7.x+ UNCOMMENT ALL `break;` LINES; 7.0 DEPRECATED THIS
if (!defined("IN_MOD")) {
...
if ((!empty($_POST['mode'])) && ($_POST['mode'] == "upload")) {
    ...
    if (empty($_FILES['upfile']['tmp_name'])) {
        ...
        if ($zip->open($tmpname) !== true) {
            ...
            echo "<b style='color: red;'>".$lang['mod/invalid_module']." 1 </b>";
...

        {
            ...
            echo "<b style='color: red;'>".$lang['mod/invalid_module']." 2 </b>";

        } else {

            //Is the JSON valid?
            $json = json_decode($zip->getFromIndex($zip->locateName("flags/module.json")));
            //var_dump($zip->getFromIndex($zip->locateName("module.json")));

            if (is_null($json)) {

                echo "<b style='color: red;'>".$lang['mod/invalid_module']." 3 </b>";
                ...
                echo "<b style='color: red;'>".$lang['mod/invalid_module']." 4 </b>";
