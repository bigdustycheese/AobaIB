...
<div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><?php echo $lang['mod/all_boards']; ?>:</h3>
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                <tbody><tr>
                                    <th><?php echo $lang['mod/directory']; ?></th>
                                    <th><?php echo $lang['mod/name']; ?></th>
                                    <th><?php echo $lang['mod/description']; ?></th>
                                    <th><?php echo $lang['mod/board_type']; ?></th>
                                    <th><?php echo $lang['mod/bump_limit']; ?></th>
                                    <th><?php echo $lang['mod/message']; ?></th>
                                    <th><?php echo $lang['mod/special']; ?></th>
                                    <th><?php echo $lang['mod/edit']; ?></th>
                                    <th><?php echo $lang['mod/delete']; ?></th>
                                    <th><?php echo $lang['mod/rebuild_cache']; ?></th>
                </tr>
                <tr>
                  <td>183</td>
                  <td>John Doe</td>
